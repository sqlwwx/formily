...
所以，我们更加推荐的是使用[@formily-x/reactive](https://reactive.formilyjs.org/zh-CN) 实现响应式受控，既能实现值受控，也能实现字段级受控
...
响应式受控主要是使用[@formily-x/reactive](https://reactive.formilyjs.org/zh-CN)实现响应式更新，我们可以轻松实现双向绑定，同时性能完爆普通受控更新
...
推荐使用[@formily-x/reactive](https://reactive.formilyjs.org/zh-CN) 实现响应式受控

...
exports.ArrayBase.Addition = function (props) {
  ...
  return react_1.default.createElement(
    antd_1.Button,
    __assign({ type: 'dashed', block: true }, props, {
      disabled:
...
exports.ArrayBase.Copy = react_1.default.forwardRef(function (props, ref) {
  var _a
  var index = useIndex(props.index)
  var array = useArray()
  var prefixCls = (0, __builtins__1.usePrefixCls)('formily-array-base')
  ...
  if (
    ...
    return null
  return react_1.default.createElement(
    icons_1.CopyOutlined,
    __assign({}, props, {
      className: (0, classnames_1.default)(
        ''.concat(prefixCls, '-copy'),
        props.className
      ),
      ref: ref,
      onClick: function (e) {
        ...
        ;(_c =
          ...
          : _c.call(_b, index)
        ;(_e =
          (_d = array.props) === null || _d === void 0 ? void 0 : _d.onCopy) ===
          null || _e === void 0
          ? void 0
          : _e.call(_d, index)
        if (props.onClick) {
...
exports.ArrayBase.mixin = function (target) {
  ...
  target.Copy = exports.ArrayBase.Copy

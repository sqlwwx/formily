...
exports.FormButtonGroup.FormItem = function (_a) {
  ...
  return react_1.default.createElement(
    ...
    __assign({}, props, {
      label: ' ',
      style: __assign(__assign({ margin: 0, padding: 0 }, props.style), {
        width: '100%',
      }),
      colon: false,
    }),
...
exports.FormButtonGroup.Sticky = function (_a) {
  ...
  var _b = __read((0, react_1.useState)('transparent'), 2),
    color = _b[0],
    setColor = _b[1]
  var prefixCls = (0, __builtins__1.usePrefixCls)('formily-button-group')
  ...
  return react_1.default.createElement(
    react_sticky_box_1.default,
    __assign({}, props, {
      className: (0, classnames_1.default)(
        ''.concat(prefixCls, '-sticky'),
        props.className
      ),
      style: __assign({ backgroundColor: color }, props.style),
      bottom: true,
    }),
    react_1.default.createElement(
      'div',

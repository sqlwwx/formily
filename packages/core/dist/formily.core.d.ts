...
import {
  FormPath,
  Subscribable,
  FormPathPattern as FormPathPattern$1,
} from '@formily/shared'
...
declare type LifeCyclePayload<T> = (
  params: {
    type: string
    payload: T
  },
...
declare class BaseField<Decorator = any, Component = any, TextType = any> {
  ...
  form: Form
  disposers: (() => void)[]
  makeIndexes(address: FormPathPattern$1): void
...
declare class Form<ValueType extends object = any> {
  ...
  clearFormGraph: (pattern?: FormPathPattern$1) => void
  validate: (pattern?: FormPathPattern$1) => any
  submit: <T>(onSubmit?: (values: any) => void | Promise<T>) => Promise<T>
  reset: (
    pattern?: FormPathPattern$1,
...
declare const isFieldState: (state: any) => state is Partial<
  Pick<
    ...
    NonFunctionPropertyNames<{
      ...
      onBlur: (...args: any[]) => Promise<void>
      validate: (
        triggerType?: _formily_validator_esm.ValidatorTriggerType
      ) => Promise<void>
      submit: <T>(onSubmit?: (values: any) => void | Promise<T>) => Promise<T>
      reset: (options?: IFieldResetOptions) => Promise<void>
      queryFeedbacks: (search?: ISearchFeedback) => IFieldFeedback[]
      ...
      designable: boolean
      form: Form<any>
      makeIndexes: (address: _formily_shared.FormPathPattern) => void
...
declare const isArrayFieldState: (state: any) => state is Partial<
  Pick<
    Field<any, any, any, any>,
    NonFunctionPropertyNames<{
      loading: boolean
...
declare const isObjectFieldState: (state: any) => state is Partial<
  Pick<
    Field<any, any, any, any>,
    NonFunctionPropertyNames<{
      loading: boolean
  ...
  >
>
declare const isVoidFieldState: (state: any) => state is Partial<
  Pick<
...
declare const onFormInitialValuesChange: (
...
declare const onFormSubmitValidateStart: (
  callback: (form: Form) => void
) => void
declare const onFormSubmitValidateSuccess: (
  callback: (form: Form) => void
) => void
declare const onFormSubmitValidateFailed: (
  callback: (form: Form) => void
) => void
...
declare const onFieldMount: (
  pattern: FormPathPattern,
  callback: (field: GeneralField, form: Form) => void
) => void
declare const onFieldUnmount: (
  pattern: FormPathPattern,
  callback: (field: GeneralField, form: Form) => void
) => void
declare const onFieldValueChange: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldInitialValueChange: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldInputValueChange: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldValidateStart: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldValidateEnd: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldValidating: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldValidateFailed: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldValidateSuccess: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmit: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitStart: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitEnd: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitValidateStart: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitValidateEnd: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitSuccess: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitFailed: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitValidateSuccess: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldSubmitValidateFailed: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldReset: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare const onFieldLoading: (
  pattern: FormPathPattern,
  callback: (field: DataField, form: Form) => void
) => void
declare function onFieldInit(
  pattern: FormPathPattern,
  callback?: (field: GeneralField, form: Form) => void
): void
declare function onFieldReact(
  pattern: FormPathPattern,
  callback?: (field: GeneralField, form: Form) => void
): void
declare function onFieldChange(
  pattern: FormPathPattern,
  callback?: (field: GeneralField, form: Form) => void
): void
declare function onFieldChange(

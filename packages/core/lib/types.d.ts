...
export declare type NonFunctionProperties<T> = Pick<
  T,
...
export declare type LifeCyclePayload<T> = (
  params: {
    type: string
    payload: T
  },
...
export declare type HeartSubscriber = ({
  type,
  payload,
}: {
  type: string
...
export declare type FieldFeedbackCodeTypes =
  | 'ValidateError'
  | 'ValidateSuccess'
  | 'ValidateWarning'
  | 'EffectError'
  ...
  | 'EffectWarning'
  | (string & {})
export declare type FormPatternTypes =
  | 'editable'
  | 'readOnly'
  | 'disabled'
  | 'readPretty'
  | ({} & string)
export declare type FormDisplayTypes =
  | 'none'
  | 'hidden'
  | 'visible'
  | ({} & string)
export declare type FormPathPattern =
  | string
  | number
  | Array<string | number>
  | FormPath
...
declare type OmitState<P> = Omit<
  ...
  | 'getFormState'
>
export declare type IFieldState = Partial<
  Pick<
    Field,
    NonFunctionPropertyNames<OmitState<Field<any, any, string, string>>>
  >
>
export declare type IVoidFieldState = Partial<
  Pick<
    VoidField,
    NonFunctionPropertyNames<OmitState<VoidField<any, any, string>>>
  >
>
export declare type IFormState<T extends Record<any, any> = any> = Pick<
  Form<T>,
...
export declare type IFormMergeStrategy =
  | 'overwrite'
  | 'merge'
  | 'deepMerge'
  | 'shallowMerge'
...
export declare type FieldDisplayTypes =
  | 'none'
  | 'hidden'
  | 'visible'
  | ({} & string)
export declare type FieldPatternTypes =
  | 'editable'
  | 'readOnly'
  | 'disabled'
  | 'readPretty'
...
export declare type FieldComponent<
  Component extends JSXComponent,
  ComponentProps = any
> = [Component] | [Component, ComponentProps] | boolean | any[]
export declare type FieldDecorator<
  Decorator extends JSXComponent,
  ComponentProps = any

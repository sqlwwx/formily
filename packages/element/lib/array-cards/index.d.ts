export declare const ArrayCards: import('vue').ComponentOptions<
  import('vue').default,
...
> &
  ...
  >) & {
    ...
    useIndex: (index?: number) => import('@vue/composition-api').Ref<number>
    useRecord: (record?: number) => import('@vue/composition-api').Ref<any>
  }

...
export declare const ArrayTable: import('vue').ComponentOptions<
  import('vue').default,
  import('@vue/composition-api').ShallowUnwrapRef<IArrayTableProps> &
...
> &
  ...
  (new (...args: any[]) => import('@vue/composition-api').ComponentRenderProxy<
    ...
    true
  >) & {
    Column: import('vue').ComponentOptions<
      never,

...
function FormDrawer(title, id, content) {
  ...
  var render = function (visible, resolve, reject) {
    ...
    if (!env.instance) {
      var ComponentConstructor = vue_2.default.extend({
        props: ['drawerProps'],
        data: function () {
          return {
            visible: false,
...
var FormDrawerFooter = (0, composition_api_1.defineComponent)({
...
FormDrawer.Protal = (0, shared_2.createPortalProvider)('form-drawer')

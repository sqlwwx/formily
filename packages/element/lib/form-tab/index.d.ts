...
export declare const FormTab: import('vue').ComponentOptions<
  import('vue').default,
...
> &
  ...
  (new (...args: any[]) => import('@vue/composition-api').ComponentRenderProxy<
    ...
    true
  >) & {
    TabPane: import('vue').ComponentOptions<
      import('vue').default,
      import('@vue/composition-api').ShallowUnwrapRef<IFormTabPaneProps> &
        import('@vue/composition-api').Data,
      {},
      {},
      {},

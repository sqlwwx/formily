export declare const usePlaceholder: (
  value?: any
) => import('@vue/composition-api').ComputedRef<any>
export declare const PreviewText: import('vue').ComponentOptions<
  import('vue').default,
...
> &
  ...
  (new (...args: any[]) => import('@vue/composition-api').ComponentRenderProxy<
    ...
    true
  >) & {
    Input: import('vue').ComponentOptions<
      import('vue').default,
    ...
    > &
      ...
      (new (
        ...
        true
      >)
    Select: import('vue').ComponentOptions<
      import('vue').default,
      import('@vue/composition-api').ShallowUnwrapRef<
        import('@vue/composition-api').Data
      > &
    ...
    > &
      ...
      (new (
        ...
        true
      >)
    Cascader: import('vue').ComponentOptions<
      import('vue').default,
      import('@vue/composition-api').ShallowUnwrapRef<
        import('@vue/composition-api').Data
      > &
    ...
    > &
      ...
      (new (
        ...
        true
      >)
    DatePicker: import('vue').ComponentOptions<
      import('vue').default,
      import('@vue/composition-api').ShallowUnwrapRef<
        import('@vue/composition-api').Data
      > &
    ...
    > &
      ...
      (new (
        ...
        true
      >)
    TimePicker: import('vue').ComponentOptions<
      import('vue').default,
      import('@vue/composition-api').ShallowUnwrapRef<
        import('@vue/composition-api').Data
      > &
    ...
    > &
      ...
      (new (
        ...
        true
      >)
    Placeholder: import('vue').Component<

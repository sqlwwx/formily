...
exports.Editable = (0, react_2.observer)(function (props) {
  ...
  var renderEditHelper = function () {
    ...
    return react_1.default.createElement(
      ...
      pattern === 'editable' &&
        react_1.default.createElement(__builtins__1.EditOutlinedIcon, {
          className: ''.concat(prefixCls, '-edit-btn'),
        }),
      pattern !== 'editable' &&
        react_1.default.createElement(__builtins__1.MessageOutlinedIcon, {
          className: ''.concat(prefixCls, '-edit-btn'),
        })
    )
  }
  var renderCloseHelper = function () {
    ...
    return react_1.default.createElement(
      form_item_1.BaseItem,
      __assign({}, props),
      react_1.default.createElement(__builtins__1.CloseOutlinedIcon, {
...
exports.Editable.Popover = (0, react_2.observer)(function (_a) {
  var props = __rest(_a, [])
  var field = (0, react_2.useField)()
  var pattern = useParentPattern()
  ...
  return react_1.default.createElement(
    ...
    __assign({}, props, {
      ...
      triggerType: 'click',
      closable: false,
      trigger: react_1.default.createElement(
        'div',

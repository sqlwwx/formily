...
var isModalTitle = function (props) {
  return (
    ...
    react_1.default.isValidElement(props)
  )
}
...
function FormDialog(title, id, renderer) {
  ...
  var modal = __assign(__assign({}, props), {
    style: __assign({ width: '40%' }, props.style),
    afterClose: function () {
      var _a
  ...
  var DialogContent = (0, react_2.observer)(function () {
    return react_1.default.createElement(
      react_1.Fragment,
      null,
      (0, shared_1.isFn)(renderer) ? renderer(env.form) : renderer
    )
  })
  var renderDialog = function (visible, resolve, reject) {
    ...
    var buttonMap = {
      ok: react_1.default.createElement(
        next_1.Button,
        __assign(
          {
            key: 'ok',
            ...
            onClick: function (e) {
              ...
              if (
                ((_a =
                  modal === null || modal === void 0 ? void 0 : modal.onOk) ===
                  null || _a === void 0
                  ? void 0
      ...
      cancel: react_1.default.createElement(
        next_1.Button,
        __assign(
          {
            key: 'cancel',
                                  ...
                                  return __generator(this, function (_a) {
                                    switch (_a.label) {
                                      ...
                                      case 1:
                                        _a.sent()
                                        resolve(
                                          (0, reactive_1.toJS)(env.form.values)
                                        )
                                        formDialog.close()
                                        return [2 /*return*/]
                                    }
...
var DialogFooter = function (props) {
  ...
  var prefixCls = (0, __builtins__1.usePrefixCls)('dialog')
  ...
  return react_1.default.createElement(
    ...
    footer && (0, react_dom_1.createPortal)(props.children, footer)
  )
}

...
export declare type IProviderProps = {
  form: Form
}
...
export declare type Path<T, Key extends keyof T = keyof T> = Key extends string
...
> = P extends `${infer Key}.${infer Rest}`
  ...
  ? T[P]
  : never
export declare type KeyOfReactComponent<T> = Exclude<
  keyof T,
  'contextTypes' | 'displayName' | 'propTypes' | 'defaultProps'
>
export declare type ReactComponentPath<
  T,
...
> = Key extends string
  ? T[Key] extends Record<string, any>
    ...
    : Key
  : never
export declare type ReactComponentPropsByPathValue<

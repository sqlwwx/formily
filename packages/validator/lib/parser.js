...
exports.parseValidator =
  exports.parseValidatorRules =
  exports.parseValidatorDescriptions =
  exports.parseValidatorDescription =
    void 0
...
var getRuleMessage = function (rule, type) {
  if (rule.format) {
    return rule.message || (0, registry_1.getValidateLocale)(rule.format)
  }
  return rule.message || (0, registry_1.getValidateLocale)(type)
}
var parseValidatorDescription = function (description) {
  var rules = {}
  if ((0, shared_1.isStr)(description)) {
    rules.format = description
  } else if ((0, shared_1.isFn)(description)) {
...
var parseValidatorDescriptions = function (validator) {
  var array = (0, shared_1.isArr)(validator) ? validator : [validator]
  return array.map(function (description) {
    return (0, exports.parseValidatorDescription)(description)
  })
}
...
var parseValidatorRules = function (rules) {
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              if ((0, shared_1.isBool)(results)) {
                ...
                if ((0, types_1.isValidateResult)(results)) {
                  return [
                    2 /*return*/,
                    (0, template_1.render)(results, context_),
                  ]
                }
                return [
                  2 /*return*/,
  ...
  return getRulesKeys().reduce(function (buf, key) {
    var callback = (0, registry_1.getValidateRules)(key)
    if (callback) {
...
var parseValidator = function (validator, options) {
  ...
  return array.reduce(function (buf, description) {
    var rules = (0, exports.parseValidatorDescription)(description)
    if (
      (options === null || options === void 0 ? void 0 : options.triggerType) &&
      options.triggerType !== rules.triggerType
    )
      return buf
    return rules ? buf.concat((0, exports.parseValidatorRules)(rules)) : buf
  }, [])
}

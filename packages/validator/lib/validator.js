...
;(0, registry_1.registerValidateRules)(rules_1.default)
;(0, registry_1.registerValidateLocale)(locale_1.default)
;(0, registry_1.registerValidateFormats)(formats_1.default)
var validate = function (value, validator, options) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          validates = (0, parser_1.parseValidator)(validator, options)
          results = {
            error: [],
            success: [],
            warning: [],
